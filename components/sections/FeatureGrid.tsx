      ...
      <ul className="mt-12 grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-4">
        {cards.map((card, i) => (
          <Reveal
            ...
            key={card.title}
            delay={(i % 4) * 0.05}
            className="group flex flex-col gap-3 rounded-2xl bg-card p-5 shadow-soft ring-1 ring-line/60 transition duration-200 ease-smooth hover:-translate-y-1 hover:shadow-lift sm:p-6"
          >
